...
###################################################
experiments_to_run = list(range(1,173))
###################################################
...
# Datasets folder
datasets_folder = "./datasets_2"
# Checkpoints folder
checkpoints_folder = "./results_2"
# Template file that needs to be generated for each experiment
slurm_template_file = f"{experiments_folder}/slurm_l65_gpu_template_seed_2"
# Output file
...
results_path = Path(os.getcwd()) / 'results_2'
...
datasets_path = Path(os.getcwd()) / 'datasets_2'
# Check if the new directory exists, and if not, create it
